...
print("  Scale: Dr. David R. Hawkins Map of Consciousness (20-600)")
...
print("  Courage (200)═ ─── Force/Power threshold ── The dividing line")
...
print()
print("  Methodology: Behavioral indicators mapped to Hawkins")
print("  consciousness scale. Based on publicly available evidence.")
